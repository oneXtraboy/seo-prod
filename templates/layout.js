...
.hero h1{font-size:clamp(2.2rem,5vw,4rem);line-height:1.02;margin:0 0 var(--s20)}.lead{font-size:1.13rem;color:var(--text2);line-height:1.62;max-width:68ch;margin-bottom:var(--s24)}
...
.btn{display:inline-flex;align-items:center;gap:8px;padding:12px 18px;border-radius:var(--pill);border:1px solid var(--border);text-decoration:none;color:var(--text);background:linear-gradient(180deg,#fff,#fafafd);box-shadow:0 1px 0 #FFFFFFB3 inset;transition:transform .16s ease,box-shadow .2s ease,background .2s ease}.btn:hover,.btn:focus-visible{transform:translateY(-1px);box-shadow:0 1px 0 #FFFFFFB3 inset,var(--shadow1)}.btn:active{transform:translateY(0)}
.btn-primary{background:linear-gradient(180deg,#0A72D8,var(--accent));color:#fff;border-color:#0A72D8}.btn-primary:hover,.btn-primary:focus-visible{background:linear-gradient(180deg,#0F7DE6,var(--accent-hover))}
.card{background:linear-gradient(180deg,#FFFFFFE6,#FFFFFFD6);border:1px solid #FFFFFFCC;border-radius:var(--r20);padding:var(--s24);box-shadow:var(--shadow1);text-align:left;line-height:1.6;transition:border-color .2s ease,box-shadow .2s ease,transform .18s ease}.card:hover{transform:translateY(-2px);border-color:#FFFFFF;box-shadow:var(--shadow2)}.card p,.card li{overflow-wrap:break-word;word-break:normal;hyphens:auto}.card h3 + p{margin-top:2px}
.kpi{font:700 clamp(1.8rem,3.2vw,2.4rem)/1.05 var(--font-rounded);letter-spacing:-.02em}.muted{color:var(--text3)}
.toc{background:linear-gradient(180deg,#FFFFFFC9,#FFFFFFAA);padding:var(--s20);border-radius:var(--r12);border:1px solid #FFFFFFCC}
...
.author-card{display:flex;gap:12px;align-items:flex-start;background:var(--surface-muted);padding:18px;border:1px solid var(--border);border-radius:var(--r12)}
