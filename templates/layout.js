...
.home-utility-bar{border-bottom:1px solid var(--divider);background:linear-gradient(180deg,var(--bg2),var(--bg))}
.home-utility-bar-in{display:flex;gap:12px;align-items:center;justify-content:space-between;padding:10px 0}
.home-utility-bar-copy{margin:0;color:var(--text2);font-size:.95rem;line-height:1.35}
.home-utility-bar-cta{white-space:nowrap}
...
@media (max-width:900px){.home-utility-bar-in{flex-direction:column;align-items:flex-start}.home-utility-bar-cta{width:auto}}
