...
.header-in{display:flex;justify-content:space-between;align-items:center;min-height:74px}.brand{display:inline-flex;align-items:center;min-height:32px;font-family:var(--font-rounded);font-weight:700;line-height:1.2;color:var(--text);text-decoration:none}.brand-current{cursor:default}.nav{display:flex;gap:18px}.nav .nav-item{display:inline-flex;flex:0 0 auto;align-items:center;justify-content:center;min-height:34px;padding:6px 10px;border-radius:10px;border:1px solid transparent;box-sizing:border-box;white-space:nowrap;font-size:16px;font-weight:400;line-height:1.2;letter-spacing:.002em;color:var(--text2);text-decoration:none;transition:background-color .18s ease,color .18s ease,border-color .18s ease,box-shadow .18s ease}.nav .nav-item-link:hover,.nav .nav-item-link:focus-visible{background:var(--surface-muted);color:var(--text)}.nav .nav-item-current{color:var(--text);background:var(--surface-muted);border-color:var(--border);box-shadow:0 1px 0 #FFFFFF80 inset;cursor:default}
