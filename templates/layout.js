...
.clients-card{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,1fr);gap:24px;min-width:100%;max-width:100%;scroll-snap-align:start;background:linear-gradient(180deg,#FFFFFFF0,#FFFFFFCC);border-color:#D9DCE3;box-shadow:0 10px 24px #0b1f350f}
...
.clients-card-visual{border:1px solid #d5dbea;border-radius:14px;background:linear-gradient(180deg,#FFFFFF,#F6F9FF);padding:16px;display:flex;align-items:center;justify-content:center;min-height:280px}
...
.clients-carousel-progress-fill{position:absolute;left:0;top:0;bottom:0;width:0;background:linear-gradient(90deg,#0F7DE6,#0066CC);border-radius:999px}
.clients-carousel-progress-thumb{position:absolute;top:50%;left:0;width:16px;height:16px;border-radius:999px;border:2px solid #fff;background:#0F7DE6;box-shadow:0 2px 8px #005fc44d;transform:translate(-50%,-50%)}
